      ...
      return function (t, s, g) {
        for (
          var h,
            ...
            x = a(m.length),
            y = 0,
            C = n ? d(t, x) : c ? d(t, 0) : void 0;
          x > y;
          y++
        )
          if ((f || y in m) && ((h = m[y]), (b = w(h, y, v)), e))
            if (n) C[y] = b;
            else if (b)
              switch (e) {
                case 3:
        ...
        (l.initialize = function () {
          ...
          (l.boot = function (t, n) {
            ...
            if (o.length) {
              ...
              e.eappsCustomPlatformUrl && (a = e.eappsCustomPlatformUrl),
                (a += "/p/boot/");
              var s = i.stringify({ w: o.join(",") });
              r.open("get", a + "?" + s),
                (r.withCredentials = !0),
                (r.onload = function () {
