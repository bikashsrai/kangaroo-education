            ...
            <div class="row height d-flex justify-content-center align-items-center">
                ...
                <div class="col-md-8">
                    ...
                    <div class="search ">
                        ...
                        <input type="text" class="form-control" placeholder="Search for nearest Location">
                ...
                <div class="col-md-4">
                    <div class="contact1">
                        ...
                        <div class="mycontact_info  a1"><span class="icon "> <i class="fa fa-phone-volume"></i></span>
                            <h6>Phone</h6>+61-2-80605365
                        </div>
                        <div class="line_separator "></div>

                        <div class="mycontact_info  a1"><span class="icon "> <i class="fas fa-envelope"></i></span>
                            <h6>Email</h6>sydney@kangarooedu.com
                        </div>
                        <div class="line_separator "></div>
                        <div class="mycontact_info  a1"><span class="icon "> <i
                                    class="fas fa-map-marker-alt"></i></span>
                            <h6>Location</h6>Suite 1001, Level 10, 307 Pitt Street Sydney, Australia NSW 2000
                        </div>
                        <div class="line_separator "></div>
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                $des_con=get_field('description_book');
                 ?>
                <div class="book_contact" style="background:url('<?php echo esc_url( $bak_img['url'] ); ?>') ">
            ...
            <div class="col-md-4 justify-content-center align-items-center m-auto">
                <div class="needhelp">
                    ...
                    <a class="btn-get-started booknow  text-center" href="#" data-bs-toggle="modal"
                        data-bs-target="#booknowModal">Book A Consultation!!</a>
                </div>
            </div>
        </div>
    </div>
