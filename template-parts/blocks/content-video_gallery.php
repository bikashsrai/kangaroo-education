                                     ...
                                     <div id="lightgallery" class="row lightGallery">
                                         <a href="https://www.youtube.com/embed/Ky9rJzJowUc" class="image-tile col-md-4"
                                             ...
                                             <div class="color-purple">
                                                 <h5 class="text-center text-white pt-2">Kangaroo New Year Celebration
                                                 </h5>
                                                 <div class="d-flex align-items-center justify-content-center mt-2 ">
                                                     <p class="badge bg-warning text-dark text-center me-2">

                                                         New Year Celebration, Review 2018
                                                     </p>
                                         ...
                                         <a href="https://www.youtube.com/embed/-IRmzaODqJE" class="image-tile col-md-4"
                                             ...
                                             <div class="demo-gallery-poster"> <img
                                                     ...
                                                     alt="image"> </div>
                                             <div class="color-purple">
                                                 <h5 class="text-center text-white pt-2">Kangaroo Australia Scholarship
                                                     Week</h5>
                                                 <div class="d-flex align-items-center justify-content-center mt-2 ">
                                                     <p class="badge bg-warning text-dark text-center me-2">
